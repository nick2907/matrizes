...
matriz.push([Math.floor(Math.random() * -10), Math.floor(Math.random() * -10), Math.floor(Math.random() * -10)]);
matriz.push([(Math.random() * 10), (Math.random() * 10),(Math.random() * 10)]);
matriz.push([(Math.random() * -10), (Math.random() * -10),(Math.random() * -10)]);

matriz2.push([(Math.random() * 10), (Math.random() * 10),(Math.random() * 10)]);
...
// imprimir a matriz 1 e colocar a matriz do lado
...
document.write("A terceira matriz é a soma da primeira matriz com a segunda:");
//imprimindo matriz 3 
document.write("<table border=2>");
